...
Reputation findings should include the provider, observation time, abuse confidence or report count when available, and any missing-configuration status. An address with no provider record is unknown, not automatically benign.
